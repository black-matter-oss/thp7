...
const SFX_BOOK_OPEN := preload("res://resources/sfx/book_open.wav")
const SFX_BOOK_CLOSE := preload("res://resources/sfx/book_close.wav")
const SFX_NOT_AVAILABLE := preload("res://resources/sfx/not_available.mp3")
const SFX_PHONE_PICK_UP := preload("res://resources/sfx/phone_pick_up.wav")
const SFX_PHONE_PUT_DOWN := preload("res://resources/sfx/phone_put_down.wav")
const SFX_PHONE_CALL := preload("res://resources/sfx/phone_call.wav")
const SFX_DING := preload("res://resources/sfx/ding.ogg")
